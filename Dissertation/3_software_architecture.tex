...
if (distance < epsilon || distance > rayMaxDistance) return false
...
C = centerToOrigin.magnitude ^ 2 - radius ^ 2
disciminant = B^2 - 4*A*C
if (discriminant < 0) return false
distance1 = -B + sqrt{discriminant}
distance2 = -B - sqrt{discriminant}
distance = min(distance1, distance2) / 2 P A
if (distance < epsilon || distance >= rayMaxDistance) return false
intersectionPoint = rayOrigin + rayDirection * distance

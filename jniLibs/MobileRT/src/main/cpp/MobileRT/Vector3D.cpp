...
Vector3D::Vector3D (const Vector3D vector1, const Vector3D vector2, const float value) noexcept :
  direction_{vector1.x_() - vector2.x_() * value, vector1.y_() - vector2.y_() * value, vector1.z_() - vector2.z_() * value},
  magnitude_ {magnitude ()}
{
...
Vector3D::Vector3D (const Vector3D vector1, const Vector3D vector2) noexcept :
  direction_ {vector1.y_() * vector2.z_() - vector1.z_() * vector2.y_(), vector1.z_() * vector2.x_() - vector1.x_() * vector2.z_(), vector1.x_() * vector2.y_() - vector1.y_() * vector2.x_()},
  magnitude_ {magnitude ()}
{
}
